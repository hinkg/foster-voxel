...
internal static partial class Platform
{
	...
	[LibraryImport(DLL)]
	public static partial void FosterSetRelativeMouseMode(int enabled);
	[LibraryImport(DLL)]
	public static partial void FosterSetMousePosition(int x, int y);
	[LibraryImport(DLL)]
	...
	[LibraryImport(DLL)]
	public static unsafe partial void FosterTextureSetSubData(nint texture, void* data, int offsetX, int offsetY, int width, int height);
	[LibraryImport(DLL)]
