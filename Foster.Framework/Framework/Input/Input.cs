...
public static class Input
{
	...
	internal static bool _mouseLocked = false;
	...
	public static bool MouseLocked
	{
		...
		set
		{
			if (_mouseLocked != value) Platform.FosterSetRelativeMouseMode(value ? 1 : 0);
			_mouseLocked = value;
		}
	}
	...
	/// <summary>
	/// Sets mouse position relative to window, will generate MouseMove event
	/// </summary>
	public static void SetMousePosition(int x, int y)
	{
		Platform.FosterSetMousePosition(x, y);
	}
