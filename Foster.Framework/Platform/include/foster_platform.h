...
FOSTER_API void FosterSetRelativeMouseMode(int mode);

FOSTER_API void FosterSetMousePosition(int x, int y);
...
FOSTER_API void FosterTextureSetSubData(FosterTexture* texture, void* data, int offsetX, int offsetY, int width, int height);
